...
{% post_image 1sharpCanvas.png "Blank SharpCanvaso" %} 

Then, add a *Frame*, I'll be calling it *SharpFrame*:

{% post_image 2frame.png "Blank SharpFrame" %} 
...
{% post_image 5setProperties.png "Linking variables" %}  

And now we're ready to create our drawing:  

{% post_image 6drawing.png "Drawing" %}  
...
{% post_image 7linkColor.png "Drawing" %}  
