...
{% post_image pages.png "Xamarin.Forms stock pages" %}
...
{% post_image layouts.png "Xamarin.Forms stock layouts" %}
...
{% post_image controls.png "Xamarin.Forms stock layouts" %}
...
{% post_image language.png "Lenguaje de interfaz gráfica" %}  
