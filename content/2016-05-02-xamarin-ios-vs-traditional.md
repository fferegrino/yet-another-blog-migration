...
{% post_image structure-comp.png "Comparison project structure" %}
...
{% post_image appdelegate.png "AppDelegate" %}
...
{% post_image outlets.png "ViewController" %}
...
{% post_image view-didload.png "ViewDidLoad method" %}
...
{% post_image event-handlers.png "Methods and event handlers" %}
...
{% post_image editor-diff.png "Editor de interfaces" %}
...
{% post_image interface-builder.png "Native interface builder" %}
